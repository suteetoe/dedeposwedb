...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-Bm7IDLJq.mjs').then((m) => m.default || m)
  },
  {
    name: "landing",
    path: "/landing",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./landing-m7DdjgOD.mjs').then((m) => m.default || m)
  },
  {
    name: "privacy",
    path: "/privacy",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./privacy-12-PcQps.mjs').then((m) => m.default || m)
  },
  {
    name: "terms",
    path: "/terms",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./terms-BCOhdBg1.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-DtrWi-XU.mjs').then((m) => m.default || m)
};
