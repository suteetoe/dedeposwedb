<template>
  <div class="px-4 sm:px-6 lg:px-8 py-10" id="en">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p>
          SMLSoft Co.,Ltd is committed to ensuring that the app is as useful and
      ...
      <p>
        You should be aware that there are certain things that SMLSoft Co.,Ltd
      ...
      <p>
        ...
        do not hesitate to contact us at info@smlsoft.com.
      </p>
