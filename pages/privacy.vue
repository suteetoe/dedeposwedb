  ...
  <div class="px-4 sm:px-6 lg:px-8 py-10" id="en">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <ul class="list-disc mx-10">
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to SML Soft co.,Ltd,
              141/469 moo2 Tonpao, Sankamphaeng, Chiang Mai 50130.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to DEDE POS, accessible from
              <a
                href="https://www.dedepos.com"
                rel="external nofollow noopener"
                target="_blank"
                >https://www.dedepos.com</a
              >
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: info@smlsoft.com</li>
        </ul>
      </div>
    </div>
  </div>
